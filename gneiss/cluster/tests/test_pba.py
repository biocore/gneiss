...
class TestPBA(unittest.TestCase):
    ...
    def test_correlation_linkage_1(self):
        ...
        exp_str = ('((o1:0.574990173931,o2:0.574990173931)y1:0.773481312844,'
                   '(o3:0.574990173931,o4:0.574990173931)y2:0.773481312844)y0;\n')
    ...
    def test_correlation_linkage_2(self):
        ...
        exp_str = ('((F4:0.228723591874,(F5:0.074748541601,(F1:0.00010428164962,'
                   'F2:0.00010428164962)y4:0.0746442599513)y3:0.153975050273)'
