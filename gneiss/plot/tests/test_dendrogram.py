...
class TestDendrogram(unittest.TestCase):
    ...
    def test_cache_ntips(self):
        ...
        self.assertEquals(t._n_tips, 4)
        self.assertEquals(t.children[0]._n_tips, 2)
        self.assertEquals(t.children[1]._n_tips, 2)
        self.assertEquals(t.children[0].children[0]._n_tips, 1)
        self.assertEquals(t.children[0].children[1]._n_tips, 1)
        self.assertEquals(t.children[1].children[0]._n_tips, 1)
        self.assertEquals(t.children[1].children[1]._n_tips, 1)
...
class TestUnrootedDendrogram(unittest.TestCase):
    ...
    def test_update_coordinates(self):
        t = UnrootedDendrogram.from_tree(self.tree)
        exp = [(-0.59847214410395644, -1.6334372886412185),
        ...
        res = t.update_coordinates(1, 0, 0, 2, 1)
